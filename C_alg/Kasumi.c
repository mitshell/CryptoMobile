 ...
 *---------------------------------------------------------------------*/
EXPORTIT void KeySchedule( u8 *k )
{
	static u16 C[] = {
 ...
 *---------------------------------------------------------*/
EXPORTIT void f8(u8 *key, u32 count, u32 bearer, u32 dir, u8 *data, int length)
{
 ...
 *---------------------------------------------------------*/
EXPORTIT u8 *f9(u8 *key, u32 count, u32 fresh, u32 dir, u8 *data, int length)
{
