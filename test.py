...
from CM import KASUMI, SNOW3G, ZUC, AES_3GPP
...
def kasumi_testset_1():
    ...
    input   = '\xea\x02G\x14\xad\\M\x84'
    output  = '\xdf\x1f\x9b%\x1c\x0b\xf4_'
    kas._initialize(key)
    return kas._cipher_block(input) == output

def kasumi_testset_2():
    kas     = KASUMI()
    key     = '\x8c\xe3>,\xc3\xc0\xb5\xfc\x1f=\xe8\xa6\xdcf\xb1\xf3'
    input   = '\xd3\xc5\xd5\x922\x7f\xb1\x1c'
    output  = '\xdeU\x19\x88\xce\xb2\xf9\xb7'
    kas._initialize(key)
    return kas._cipher_block(input) == output
...
def kasumi_testset_3():
    ...
    input   = 'b\xa5@\x98\x1b\xa6\xf9\xb7'
    output  = 'E\x92\xb0\xe7\x86\x90\xf7\x1b'
    kas._initialize(key)
    return kas._cipher_block(input) == output

def kasumi_testset_4():
    kas     = KASUMI()
    key     = ':;9\xb5\xc3\xf27mi\xf7\xd5F\xe5\xf8]C'
    input   = '\xcaI\xc1\xc7Wq\xab\x0b'
    output  = 's\x8b\xadLJi\x08\x02'
    kas._initialize(key)
    for i in range(50):
...
def kasumi_F8_testset_1():
    ...
    bitlen  = 798
    output  = '\xd1\xe2\xdep\xee\xf8lid\xfbT+\xc2\xd4`\xaa\xbf\xaa\x10\xa4\xa0\x93&+}\x19\x9epo\xc2\xd4\x89\x15S)i\x10\xf3\xa9s\x01&\x82\xe4\x1cN+\x02\xbe \x17\xb7%;\xbf\x93\t\xdeX\x19\xcbB\xe8\x19V\xf4\xc9\x9b\xc9v\\\xafS\xb1\xd0\xbb\x82y\x82j\xdb\xbcU"\xe9\x15\xc1 \xa6\x18\xa5\xa7\xf5\xe8\x97\x08\x939e\x0c' # was \x0f' in the spec, because last bits are not zeroed
    return kas.F8(key, count, bearer, direct, data, bitlen) == output

def kasumi_F8_testset_2():
    kas     = KASUMI()
    key     = '\xef\xa8\xb2"\x9er\x0c*|6\xeaU\xe9`V\x95'
    count   = 3800813435
    bearer  = 24
    direct  = 0
    data    = "\x10\x11\x121\xe0`%:C\xfd?W\xe3v\x07\xab('\xb5\x99\xb6\xb1\xbb\xda7\xa8\xab\xccZ\x8cU\r\x1b\xfb/IF$\xfbP6\x7f\xa3l\xe3\xbch\xf1\x1c\xf9;\x15\x107k\x02\x13\x0f\x81*\x9f\xa1i\xd8"
    bitlen  = 510
    output  = '=\xea\xcc|\x15\x82\x1c\xaa\x89\xee\xca\xde\x9b[\xd3aK\xd0\xc8A\x9dq\x03\x85\xdd\xbeXI\xef\x1b\xacZ\xe8\xb1J[\ngAR\x1e\xb4\xe0\x0b\xb9\xec\xf3\xe9\xf7\xcc\xb9\xca\xe7AR\xd7\xf4\xe2\xa04\xb6\xea\x00\xec'
    return kas.F8(key, count, bearer, direct, data, bitlen) == output

def kasumi_F8_testset_3():
    kas     = KASUMI()
    key     = 'Z\xcb\x1ddL\rQ N\xa5\xf1E\x10\x10\xd8R'
    count   = 4199901990
    bearer  = 3
    direct  = 1
    data    = '\xad\x9cD\x1f\x89\x0b8\xc4W\xa4\x9dB\x14\x07\xe8'
    bitlen  = 120
    output  = '\x9b\xc9,\xa8\x03\xc6{(\xa1\x1aK\xeeZ\x0c%'
    return kas.F8(key, count, bearer, direct, data, bitlen) == output
...
def kasumi_F8_testset_4():
    ...
    bitlen  = 253
    output  = '[\xb9C\x1b\xb1\xe9\x8b\xd1\x1b\x93\xdb|=E\x13eY\xbb\x86\xa2\x95\xaa N\xcb\xeb\xf6\xf7\xa5\x10\x15\x10' # was \x12'
    return kas.F8(key, count, bearer, direct, data, bitlen) == output

def kasumi_F8_testset_5():
    kas     = KASUMI()
    key     = '`\x90\xea\xe0L\x83pn\xec\xbfe+\xe8\xe3ef'
    count   = 1923412495
    bearer  = 9
    direct  = 0
    data    = '@\x98\x1b\xa6\x82L\x1b\xfbB\x86\xb2\x99x=\xafD,\t\x9fz\xb0\xf5\x8d\\\x8eF\xb1\x04\xf0\x8f\x01\xb4\x1a\xb4\x85G )\xb7\x1d6\xbd\x1a=\x90\xdc:A\xb4mQg*\xc4\xc9f:+\xe0c\xdaK\xc8\xd2\x80\x8c\xe3>,\xcc\xbf\xc64\xe1\xb2Y\x06\x08v\xa0\xfb\xb5\xa47\xeb\xcc\x8d1\xc1\x9eDT1\x87E\xe3\x98vE\x98z\x98o,\xb0'
    bitlen  = 837
    output  = '\xdd\xb3d\xdd*\xae\xc2M\xff)\x19W\xb7\x8b\xad\x06:\xc5y\xcd\x90A\xba\xbe\x89\xfd\x19\\\x05x\xcb\x9f\xdeB\x17Vax\xd2\x02@ m\x07\xcf\xa6\x19\xec\x05\x9fcQDY\xfc\x10\xd4-\xc9\x93NV\xeb\xc0\xcb\xc6\rM-\xf1twL\xbd\xcd]\xa4\xa3P1z\x7f\x12\xe1\x94\x94q\xf8\xa2\x95\xf2r\xe6\x8f\xc0qY\xb0}\x8e-&\xe4Y\x98' # was \x9e' in the spec, because last bits are not zeroed
    return kas.F8(key, count, bearer, direct, data, bitlen) == output
...
def kasumi_F9_testset_1():
    ...
    fresh   = 97709129
    direct  = 0
    data    = 'k"w7)o9<\x80y5>\xdc\x87\xe2\xe8\x05\xd2\xecI\xa4\xf2\xd8\xe0'
    bitlen  = 189
    mac     = '\xf6;\xd7,'
...
def kasumi_F9_testset_2():
    kas     = KASUMI()
    key     = '\xd4/h$( \x1c\xaf\xcd\x9f\x97\x94^m\xe7\xb7'
    count   = 1054640098
    fresh   = 2767378658
    direct  = 1
    data    = '\xb5\x92C\x842\x8aJ\xe0\x0bsq\t\xf8\xb6\xc8\xdd+M\xb6=\xd53\x98\x1c\xeb\x19\xaa\xd5*[+\xc0'
    bitlen  = 254
    mac     = '\xa9\xda\xf1\xff'
    return kas.F9(key, count, fresh, direct, data, bitlen) == mac
...
def kasumi_F9_testset_3():
    kas     = KASUMI()
    key     = '\xfd\xb9\xcf\xdf(\x93l\xc4\x83\xa3\x18i\xd8\x1b\x8f\xab'
    count   = 917463364
    fresh   = 2553868346
    direct  = 1
...
def kasumi_F9_testset_4():
    kas     = KASUMI()
    key     = '\xc76\xc6\xaa\xb2+\xff\xf9\x1e&\x98\xd2\xe2*\xd5~'
    count   = 343490113
    fresh   = 60287229
    direct  = 1
    data    = "\xd0\xa7\xd4c\xdf\x9f\xb2\xb2x\x83?\xa0.#Z\xa1r\xbd\x97\x0c\x14s\xe1)\x07\xfbd\x8be\x99\xaa\xa0\xb2J\x03\x86eB+ \xa4\x99'jPBp\t"
    bitlen  = 384
    mac     = '\xdd}\xfa\xdd'
    return kas.F9(key, count, fresh, direct, data, bitlen) == mac
...
def kasumi_F9_testset_5():
    kas     = KASUMI()
    key     = '\xf4\xeb\xeci\xe7>\xaf.\xb2\xcfj\xf4\xb3\x12\x0f\xfd'
    count   = 695155004
    fresh   = 1797420855
    direct  = 1
...
def snow3g_testset_1():
    snow    = SNOW3G()
    key     = '+\xd6E\x9f\x82\xc5\xb3\x00\x95,I\x10H\x81\xffH'
    iv      = '\xea\x02G\x14\xad\\M\x84\xdf\x1f\x9b%\x1c\x0b\xf4_'
    output  = '\xab\xee\x97\x04z\xc3\x13s'
...
def snow3g_testset_2():
    snow    = SNOW3G()
    key     = '\x8c\xe3>,\xc3\xc0\xb5\xfc\x1f=\xe8\xa6\xdcf\xb1\xf3'
    iv      = '\xd3\xc5\xd5\x922\x7f\xb1\x1c\xdeU\x19\x88\xce\xb2\xf9\xb7'
    output  = '\xef\xf8\xa3B\xf7QH\x0f'
    snow._initialize(key, iv)
    return snow._generate_keystream(8) == output
...
def snow3g_testset_3():
    snow    = SNOW3G()
    key     = '@5\xc6h\n\xf8\xc6\xd1\xa8\xff\x86g\xb1q@\x13'
    iv      = 'b\xa5@\x98\x1b\xa6\xf9\xb7E\x92\xb0\xe7\x86\x90\xf7\x1b'
    output  = '\xa8\xc8t\xa9z\xe7\xc4\xf8'
    snow._initialize(key, iv)
    return snow._generate_keystream(8) == output

def snow3g_testset_4():
    snow    = SNOW3G()
    key     = '\r\xedrc\x10\x9c\xf9.3R%Z\x14\x0e\x0fv'
    iv      = 'kh\x07\x9aA\xa7\xc4\xc9\x1b\xef\xd7\x9f\x7f\xdc\xc23'
    output  = ('\xd7\x12\xc0\\\xa97\xc2\xa6\xeb~\xaa\xe3', '\x9c\r\xb3\xaa')
    snow._initialize(key, iv)
...
def snow3g_F8_testset_1():
    ...
    data    = '~\xc6\x12rt;\xf1aG&Djl8\xce\xd1f\xf6\xcav\xebT0\x04B\x864l\xef\x13\x0f\x92\x92+\x03E\r:\x99u\xe5\xbd.\xa0\xebU\xad\x8e\x1b\x19\x9e>\xc41` \xe9\xa1\xb2\x85\xe7bySY\xb7\xbd\xfd9\xbe\xf4\xb2HE\x83\xd5\xaf\xe0\x82\xae\xe68\xbf_\xd5\xa6\x06\x199\x01\xa0\x8fJ\xb4\x1a\xab\x9b\x13H\x80'
    bitlen  = 798
    output  = '\x8c\xeb\xa6)C\xdc\xed:\t\x90\xb0n\xa1\xb0\xa2\xc4\xfb<\xed\xc7\x1b6\x9fB\xbad\xc1\xebfe\xe7*\xa1\xc9\xbb\r\xea\xa2\x0f\xe8`X\xb8\xba\xee,.\x7f\x0b\xec\xceH\xb5)2\xa5<\x9d_\x93\x1a:|S"Y\xafC%\xe2\xa6^0\x84\xad_jQ;{\xdd\xc1\xb6_\n\xa0\xd9z\x05=\xb5Z\x88\xc4\xc4\xf9`^A@'
...
def snow3g_F8_testset_2():
    ...
    data    = "\x10\x11\x121\xe0`%:C\xfd?W\xe3v\x07\xab('\xb5\x99\xb6\xb1\xbb\xda7\xa8\xab\xccZ\x8cU\r\x1b\xfb/IF$\xfbP6\x7f\xa3l\xe3\xbch\xf1\x1c\xf9;\x15\x107k\x02\x13\x0f\x81*\x9f\xa1i\xd8"
    bitlen  = 510
    output  = '\xe0\xda\x15\xca\x8e%T\xf5\xe5l\x94h\xdcl|\x12\x9cV\x8a\xa5\x03#\x17\xe0N\x07)dl\xab\xef\xa6\x89\x86LA\x0f$\xf9\x19\xe6\x1e=\xfd\xfa\xd7~V\r\xb0\xa9\xcd6\xc3J\xe4\x18\x14\x90\xb2\x9f_\xa2\xfc'
    return snow.F8(key, count, bearer, direct, data, bitlen) == output
...
def snow3g_F8_testset_3():
    ...
    data    = '\xad\x9cD\x1f\x89\x0b8\xc4W\xa4\x9dB\x14\x07\xe8'
    bitlen  = 120
    output  = '\xba\x0f10\x034\xc5kR\xa7I|\xba\xc0F'
    return snow.F8(key, count, bearer, direct, data, bitlen) == output
...
def snow3g_F8_testset_4():
    ...
    data    = '\x98\x1b\xa6\x82L\x1b\xfb\x1a\xb4\x85G )\xb7\x1d\x80\x8c\xe3>,\xc3\xc0\xb5\xfc\x1f=\xe8\xa6\xdcf\xb1\xf0'
    bitlen  = 253
    output  = "\x98\x9bq\x9c\xdc3\xce\xb7\xcf'jR\x82|\xef\x94\xa5l@\xc0\xab\x9d\x81\xf7\xa2\xa9\xba\xc6\x0e\x11\xc4\xb0"
    return snow.F8(key, count, bearer, direct, data, bitlen) == output
...
def snow3g_F8_testset_5():
    ...
    data    = '@\x98\x1b\xa6\x82L\x1b\xfbB\x86\xb2\x99x=\xafD,\t\x9fz\xb0\xf5\x8d\\\x8eF\xb1\x04\xf0\x8f\x01\xb4\x1a\xb4\x85G )\xb7\x1d6\xbd\x1a=\x90\xdc:A\xb4mQg*\xc4\xc9f:+\xe0c\xdaK\xc8\xd2\x80\x8c\xe3>,\xcc\xbf\xc64\xe1\xb2Y\x06\x08v\xa0\xfb\xb5\xa47\xeb\xcc\x8d1\xc1\x9eDT1\x87E\xe3\x98vE\x98z\x98o,\xb0'
    bitlen  = 837
    output  = 'X\x92\xbb\xa8\x8b\xbb\xca\xae\xaev\x9a\xa0kh=:\x17\xcc\x04\xa3i\x88\x16\x97C^D\xfe\xd5\xff\x9a\xf5{\x9e\x89\rM\\dp\x98\x85\xd4\x8a\xe4\x06\x90\xec\x04;\xaa\xe9pW\x96\xe4\xa9\xffZK\x8d\x8b6\xd7\xf3\xfeW\xccl\xfdl\xd0\x05\xcd8R\xa8^\x94\xcek\xcd\x90\xd0\xd0x9\xce\ts5D\xca\x8e5\x08C$\x85P\x92*\xc1(\x18'
    return snow.F8(key, count, bearer, direct, data, bitlen) == output
...
def snow3g_EIA1_testset_1():
    ...
    bearer  = 31
    direct  = 0
    data    = '324bc98a74y\x00\x00\x00\x00\x00'
    bitlen  = 88
    output  = 's\x1f\x11e'
...
def zuc_testset_1():
    ...
    key     = 16 * '\0'
    iv      = 16 * '\0' 
    output  = "'\xbe\xdet\x01\x80\x82\xda"
...
def zuc_testset_2():
    ...
    key     = 16 * '\xff'
    iv      = 16 * '\xff' 
    output  = '\x06W\xcf\xa0p\x969\x8b'
    zuc._initialize(key, iv)
    return zuc._generate_keystream(8) == output

def zuc_testset_3():
    zuc     = ZUC()
    key     = '=LK\xe9j\x82\xfd\xae\xb5\x8fd\x1d\xb1{E['
    iv      = '\x841\x9a\xa8\xdei\x15\xca\x1fk\xdak\xfb\xd8\xc7f'
    output  = '\x14\xf1\xc2r2y\xc4\x19'
    zuc._initialize(key, iv)
    return zuc._generate_keystream(8) == output

def zuc_testset_4():
    zuc     = ZUC()
    key     = 'M2\x0b\xfa\xd4\xc2\x85\xbf\xd6\xb8\xbd\x00\xf3\x9d\x8bA'
    iv      = 'R\x95\x9d\xab\xa0\xbf\x17n\xce-\xc3\x15\x04\x9e\xb5t'
    output  = ('\xedD\x00\xe7\x063\xe5\xc5', 'zWL\xdb')
    zuc._initialize(key, iv)
...
def zuc_EEA3_testset_1():
    zuc     = ZUC()
    key     = '\x17=\x14\xbaP\x03s\x1dz`\x04\x94p\xf0\n)'
    count   = 0x66035492
    bearer  = 0xf
    direct  = 0
    data    = 'l\xf6S@sUR\xab\x0c\x97R\xfao\x90%\xfe\x0b\xd6u\xd9\x00Xu'\
    '\xb2\x00\x00\x00\x00'
    bitlen  = 193
    output  = '\xa6\xc8_\xc6j\xfb\x853\xaa\xfc%\x18\xdf\xe7\x84\x94\x0e'\
    '\xe1\xe4\xb00#\x8c\xc8\x00'
    return zuc.EEA3(key, count, bearer, direct, data, bitlen) == output

def zuc_EEA3_testset_2():
    zuc     = ZUC()
    key     = '\xe5\xbd>\xa0\xebU\xad\xe8f\xc6\xacX\xbdT0*'
    count   = 0x56823
    bearer  = 0x18
    direct  = 1
    data    = '\x14\xa8\xefi=g\x85\x07\xbb\xe7\'\n\x7fg\xffP\x06\xc3R[\x98\x07\xe4g\xc4\xe5`\x00\xba3\x8f]B\x95Y\x03gQ\x82"F\xc8\r;8\xf0\x7fK\xe2\xd8\xffX\x05\xf5\x13")\xbd\xe9;\xbb\xdc\xaf8+\xf1\xee\x97/\xbf\x99w\xba\xda\x89E\x84z*l\x9a\xd3JfuT\xe0M\x1f\x7f\xa2\xc32A\xbd\x8f\x01\xba"\r'
    bitlen  = 800
    output  = '\x13\x1dC\xe0\xde\xa1\xbe\\Z\x1b\xfd\x97\x1d\x85,\xbfq-{OW\x96\x1f\xea2\x08\xaf\xa8\xbc\xa43\xf4V\xad\t\xc7A~X\xbci\xcf\x88f\xd15?t\x86^\x80x\x1d -\xfb>\xcf\xf7\xfc\xbc;\x19\x0f\xe8* N\xd0\xe3P\xfc\x0fo&\x13\xb2\xf2\xbc\xa6\xdfZG:W\xa4\xa0\r\x98^\xba\xd8\x80\xd6\xf28d\xa0{\x01'
    return zuc.EEA3(key, count, bearer, direct, data, bitlen) == output

def zuc_EEA3_testset_3():
    zuc     = ZUC()
    key     = '\xd4U*\x8f\xd6\xe6\x1c\xc8\x1a \t\x14\x1a)\xc1\x0b'
    count   = 0x76452ec1
    bearer  = 2
    direct  = 1
    data    = '8\xf0\x7fK\xe2\xd8\xffX\x05\xf5\x13")\xbd\xe9;\xbb\xdc\xaf8+\xf1\xee\x97/\xbf\x99w\xba\xda\x89E\x84z*l\x9a\xd3JfuT\xe0M\x1f\x7f\xa2\xc32A\xbd\x8f\x01\xba"\r<\xa4\xecA\xe0tY_T\xae+EO\xd9qC C`\x19e\xcc\xa8\\$\x17\xedl\xbe\xc3\xba\xda\x84\xfc\x8aW\x9a\xeax7\xb0\'\x11w$*d\xdc\n\x9d\xe7\x1a\x8e\xde\xe8l\xa3\xd4}\x03=k\xf59\x80N\xca\x86\xc5\x84\xa9\x05-\xe4j\xd3\xfc\xedeT;\xd9\x02\x077+\'\xaf\xb7\x924\xf5\xffC\xea\x87\x08 \xe2\xc2\xb7\x8a\x8a\xaea\xcc\xe5*\x05\x15\xe3H\xd1\x96fJ4V\xb1\x82\xa0|@nJ y\x12q\xcf\xed\xa1e\xd55\xec^\xa2\xd4\xdf@\x00\x00\x00'
    bitlen  = 1570
...
###
def testall():
    return kasumi_testsets() & snow3g_testsets() & \
            zuc_testsets() & aes_testsets()
